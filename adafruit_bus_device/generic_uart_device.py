...
"""
`adafruit_bus_device.generic_uart_device` - Generic UART Device
====================================================
"""
...
class GenericUARTDevice:
    ...
    def __init__(self, uart, read_func=None, write_func=None, readreg_func=None, writereg_func=None):
        self._uart = uart
    ...
    def read_register(self, addr_buf: bytes, addr_len: int, data_buf: bytearray, data_len: int) -> int:
